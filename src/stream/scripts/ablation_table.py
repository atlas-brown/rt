...
def main() -> None:
    ...
    lines = [
        "| Ann | Label | RT | w/o heus | w/o FSTs |  |",
        "|---|---|---:|---:|---:|---|",
    ]
    ...
    for ann_label in ("w/o ann", "w/ ann"):
        ...
        lines.append(
            f"| {ann_label} | correct | {correct_rt} / {correct_total} | {correct_wo_heus} / {correct_total} | {correct_wo_fsts} / {correct_total} |  |"
        )
        lines.append(
            f"| {ann_label} | buggy | {buggy_rt} / {buggy_total} | {buggy_wo_heus} / {buggy_total} | {buggy_wo_fsts} / {buggy_total} |  |"
        )
