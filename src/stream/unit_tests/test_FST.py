import random
import string
from stream.transducer import first_regex_replacement_FST, first_replacement_FST, global_replacement_FST, translation_FST, compression_FST, deletion_FST, cut_field_FST, global_regex_replacement_FST
