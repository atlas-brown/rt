...
_readKeyLengthFromCSR() {
  ...
  if _contains "$_outcsr" "Public Key Algorithm: id-ecPublicKey"; then
    ...
    _debug "RSA CSR"
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/805
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/148f869becd09518d015881763ab3f2ba98bfa2c
