...
################################################################################
# Commit message: move getting zone id code into its own function
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ea18c47011279cbabbba4e857abea5a2a92e8a3a
