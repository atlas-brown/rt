...
################################################################################
# Commit message: use lower_case util function instead of raw bash command
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/cc9c85cc1aab1f4aa5a06b6b1e44f5d1ecee4a3c
