...
################################################################################
# Commit message: Minor - Corrected var names  Kilobyte values are used, not Bytes.
# Commit URL: https://github.com/pi-hole/pi-hole/commit/6c0a8a43377bc24994e50cc2c6c6b7c6956a088c
