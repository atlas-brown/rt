...
################################################################################
# Commit message: fix(nvm): use `command cat` to avoid alias (#12410)
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/9af7ebcf36c20e1490a50fa5bab6319275859c17
