...
################################################################################
# Commit message: get both the CSRF token and session ID cookies, as they are both needed for login now
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/92f13eb8bf329523e618b32e97283cb4bf392126
# Category: completely out of the scope
# Notes: 
# Changed content:
