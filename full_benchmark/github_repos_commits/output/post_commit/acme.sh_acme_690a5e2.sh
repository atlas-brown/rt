...
_digest() {
  ...
  if [ "$alg" = "sha256" ] || [ "$alg" = "sha1" ]; then
    if [ "$outputhex" ] ; then
################################################################################
# Commit message: Support Ovh domain api (#273)  * support ovh  * fix success link  * fix OVH issues.  * v2.4.3 Support OVH domain api
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/690a5e205daf5ad8d58a1be4b21e9ba676d7f18d
