...
################################################################################
# Commit message: Increase security using https for MyDNS.JP API
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/be5085f2052321f0fa1887bd7be7b3ca0de52aa2
