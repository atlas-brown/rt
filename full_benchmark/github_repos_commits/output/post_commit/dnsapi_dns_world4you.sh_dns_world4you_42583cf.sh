...
################################################################################
# Commit message: World4You Shellcheck
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/42583cf3bb6d4ea091491533d33d1717f746065f
# Category: may be detected by annotations
# Notes: can be detected by shell check, an annotation should be an empty string
# Changed content:
