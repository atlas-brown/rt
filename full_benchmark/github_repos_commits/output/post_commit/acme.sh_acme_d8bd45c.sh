...
################################################################################
# Commit message: Fix issue #2833 with backslash in JSON  Backslash will be removed form JSON responses for each request and for the initial configuration request
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d8bd45c2bda3f520bc31d6510f6802ee736bf4a1
# Category: about custom commands
# Notes: 
# Changed content:
