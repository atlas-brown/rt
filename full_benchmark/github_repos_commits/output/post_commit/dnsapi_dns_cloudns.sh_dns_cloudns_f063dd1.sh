...
################################################################################
# Commit message: some additional fixes and removed awk
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/f063dd195e44c099c0c65322049745af5cbb063a
# Category: hard awk
# Notes: 
# Changed content:
