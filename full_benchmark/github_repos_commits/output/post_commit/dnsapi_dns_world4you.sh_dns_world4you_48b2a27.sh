...
################################################################################
# Commit message: World4You Bugfix unable to parse paketnr
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/48b2a271cc81a7ab8bf2bc229aa59d58f88c493e
# Category: hard sed
# Notes: 
# Changed content:
