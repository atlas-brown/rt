...
################################################################################
# Commit message: systemadmin: fix header line sorting in pscpu (#6167)  Inside `pscpu` and `pscpu10` aliases, remove sorting of the header line.
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/d88fbe625f0a7c6f7296a58e0cd919903cd81511
# Category: semantic mistake - key of sort
# Notes: key of sort
# Changed content:
