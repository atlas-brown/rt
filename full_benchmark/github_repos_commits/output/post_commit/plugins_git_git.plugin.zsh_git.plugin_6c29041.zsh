...
################################################################################
# Commit message: git plugin: global var for git command due to issues like #3962 until a proper plugin-loading system is implemented
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/6c29041af73fc3668f6a3256ebc7ab532a2bbba9
