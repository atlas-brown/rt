...
_ddnss_rest() {
  ...
  if [ "$method" = "GET" ]; then
################################################################################
# Commit message: Removed -e and changed tail to funktion
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/fecc5b09f879c95cf734dc3f1e2ef0f7c6248a1a
