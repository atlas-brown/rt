...
function finalWork {
################################################################################
# Commit message: Add option for uploading debug log to termbin
# Commit URL: https://github.com/pi-hole/pi-hole/commit/a3b3a7a34dfbef0eb73c915829bca18aedfca700
