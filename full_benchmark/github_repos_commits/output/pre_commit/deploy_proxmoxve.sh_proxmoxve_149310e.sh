...
{
################################################################################
# Commit message: '+' are being converted to ' ' at some point
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/149310e1ecdec3343757296cab9ebf6975693d5d
