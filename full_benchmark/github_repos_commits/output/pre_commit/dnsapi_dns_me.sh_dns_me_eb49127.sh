...
################################################################################
# Commit message: improve id parse  Locate only the outer most "id" property
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/eb49127b9ec75472c663eaaebb6370ab95a3f357
# Category: hard sed
# Notes: 
# Changed content:
