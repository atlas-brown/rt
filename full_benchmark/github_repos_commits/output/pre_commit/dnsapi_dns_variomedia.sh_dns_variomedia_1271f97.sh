...
################################################################################
# Commit message: fixed dns_variomedia_rm for wildcard certs  fixed dns_variomedia_rm to respect the txtvalue supplied as function parameter
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/1271f97b669ee66727293beea3f2a39da2899e04
# Category: hard sed
# Notes: 
# Changed content:
