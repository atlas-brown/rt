...
spinner()
{
    ...
    local spinstr='|/-\'
################################################################################
# Commit message: Prompt user to remove each dependent package if they do choose to remove packages at all.
# Commit URL: https://github.com/pi-hole/pi-hole/commit/5442954db6cd63a81eddc3e66d5cd48179102d52
