...
################################################################################
# Commit message: --force seems to light. lets try --i_do_not_follow_recommendations
# Commit URL: https://github.com/pi-hole/pi-hole/commit/aca5064743ed9639ca69eb03c031de51147fc22d
