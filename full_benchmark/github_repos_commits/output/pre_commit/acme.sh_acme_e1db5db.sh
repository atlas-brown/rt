...
_send_signed_request() {
  ...
  while [ "${_request_retry_times}" -lt "$MAX_REQUEST_RETRY_TIMES" ]; do
    ...
    if [ "$needbase64" ]; then
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/1105
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/e1db5db8ac4604c123fbbfe3c87615b25657820c
