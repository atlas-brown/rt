...
################################################################################
# Commit message: use head instead of tail so that the sessionid cookie gets set correctly
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d317b49940adc07fc33f0d2cf0f011e4f1da0e03
# Category: semantic mistake - add/drop head/tail
# Notes: 
# Changed content:
