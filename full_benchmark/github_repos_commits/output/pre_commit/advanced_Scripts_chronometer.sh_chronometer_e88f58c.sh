...
CalcQueriesToday() {
	if [ -e "${piLog}" ]; then
################################################################################
# Commit message: Remove grpping for today's log entries, because we flush the log every day
# Commit URL: https://github.com/pi-hole/pi-hole/commit/e88f58c34ecba8969e458fbcc0e80e1204f0dde5
