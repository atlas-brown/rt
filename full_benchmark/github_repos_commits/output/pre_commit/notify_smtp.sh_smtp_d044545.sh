...
################################################################################
# Commit message: Rework read/save config to not save default values  Add and use _readaccountconf_mutable_default and _saveaccountconf_mutable_default helpers to capture common default value handling.  New approach also eliminates need for separate underscore-prefixed version of each conf var.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d0445455200076f2470752fad648c61c2c48780c
# Category: about variables
# Notes: 
# Changed content:
