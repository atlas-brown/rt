...
_get_base_domain() {
  # args
################################################################################
# Commit message: Made dns_dgon.sh use _lower_case  Fixed private function which breaks on embedded systems before.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/189a7766d4fc4684ba971147474a7dd3187a29dd
