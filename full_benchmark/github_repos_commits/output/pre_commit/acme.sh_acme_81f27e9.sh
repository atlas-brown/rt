...
################################################################################
# Commit message: minor, get the error info, if it contains CRLF
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/81f27e907723079c82789d82ceb14977a2554e4b
