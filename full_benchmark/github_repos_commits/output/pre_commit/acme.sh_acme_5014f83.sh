...
$_authorizations_map"
    ...
    while true; do
      ...
      if [ "$ACME_VERSION" = "2" ]; then
        _idn_d="$(_idn "$d")"
################################################################################
# Commit message: Fix case sensitive detection of domain in the response request
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/5014f83b86cf456869063043a526476dd9937d46
