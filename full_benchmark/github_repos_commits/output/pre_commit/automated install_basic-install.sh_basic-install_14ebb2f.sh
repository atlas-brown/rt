...
setStaticIPv4() {
    ...
    if is_command nmcli && nmcli general status &> /dev/null; then
################################################################################
# Commit message: remove 'System' from NetworkManager connection name  Signed-off-by: bcambl <blayne@blaynecampbell.com>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/14ebb2fb93dfa5c3669b21f9e9618edea9d71f99
