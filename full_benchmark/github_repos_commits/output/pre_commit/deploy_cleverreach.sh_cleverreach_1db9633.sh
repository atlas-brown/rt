...
################################################################################
# Commit message: Rework based on review from Neilpang
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/1db963361c4b832c048b8d85fe302d37b5d41cec
