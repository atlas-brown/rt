...
################################################################################
# Commit message: Only filter the package npm, not any package name contains 'npm'
# Commit URL: https://github.com/nvm-sh/nvm/commit/bf7bd3e793adfac2069f2f4bc5225765d347fa25
