...
################################################################################
# Commit message: [Robustness] add `command` to `xargs`/`rm` in `nvm_get_default_packages`  Fixes #2281.
# Commit URL: https://github.com/nvm-sh/nvm/commit/16b75b7333f988279195f75dcf1ec8217ceb43df
