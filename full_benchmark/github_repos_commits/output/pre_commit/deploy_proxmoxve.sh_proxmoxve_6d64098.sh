...
{
################################################################################
# Commit message: shell check war warning against unnecessary use of cat
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/6d640982885c849172656ddcb68d01c98dbacea5
