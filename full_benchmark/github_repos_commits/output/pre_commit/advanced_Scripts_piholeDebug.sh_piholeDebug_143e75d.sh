...
check_required_ports() {
  ...
  while IFS= read -r line; do
      ports_in_use+=( "$line" )
################################################################################
# Commit message: fix empty ports on some systems  Signed-off-by: Jacob Salmela <jacob.salmela@pi-hole.net>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/143e75d213a0cbcf9b2f179fe4e4a095c248c8e1
# Category: hard awk
# Notes: 
# Changed content:
