...
nvm() {
  ...
  case $1 in
    ...
    "copy-packages" )
      ...
      local INSTALLS
################################################################################
# Commit message: Don't try to copy `npm` itself with `nvm copy-packages`.  Fixes #504.
# Commit URL: https://github.com/nvm-sh/nvm/commit/56c40cfa3cd17c37c1c7f56fe19580beb8e35db7
# Category: 
# Notes: 
# Changed content:
