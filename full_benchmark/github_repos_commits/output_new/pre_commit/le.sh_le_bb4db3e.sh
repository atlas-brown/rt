...
################################################################################
# Commit message: In case /home/ivan/.le points to a symlink, it does not displays the contents with a simple 'ls'. Added a slash to force list the folder content.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/bb4db3e9743d6945a2f4d51e1ae1ffeb215c7a75
# Category: 
# Notes: 
# Changed content:
