...
################################################################################
# Commit message: dns_gdnsdk: Fixed stupid regex error, want literal "-", not a range
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/7679df062c246e72c24ce2a57ca5d58cd02095ca
# Category: 
# Notes: 
# Changed content:
