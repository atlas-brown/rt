...
get_binary_name() {
    ...
    if [[ "${machine}" == "arm"* || "${machine}" == *"aarch"* ]]; then
        ...
        local lib
################################################################################
# Commit message: Update automated install/basic-install.sh  Co-authored-by: Dan Schaper <dan.schaper@pi-hole.net>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/9840148ba95678c7b9316e171fd2a4659a88c1d3
# Category: 
# Notes: 
# Changed content:
