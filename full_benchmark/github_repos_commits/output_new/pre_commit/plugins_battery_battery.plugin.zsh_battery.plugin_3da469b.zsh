...
################################################################################
# Commit message: battery: fix Full battery bug on Linux; force 1-char-width on charging symbol
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/3da469be5c9526d4219ce4469e3a1e3fd7685b88
# Category: 
# Notes: 
# Changed content:
