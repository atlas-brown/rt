...
_get_root() {
  ...
  while true; do
    ...
    if _contains "$_all_domains" "^$h$"; then
      ...
      _domain=$h
################################################################################
# Commit message: #2547 fix multiply _service selection
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/9666cf680e87df90238480ca960d2a7ff83692b3
# Category: 
# Notes: 
# Changed content:
