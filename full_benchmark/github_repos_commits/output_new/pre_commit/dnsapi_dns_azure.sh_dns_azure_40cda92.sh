...
dns_azure_rm() {
  ...
  if [ "$_code" = "200" ]; then
################################################################################
# Commit message: fix https://github.com/acmesh-official/acme.sh/issues/3077
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/40cda9220aa3902b11cb9f38a7dc38b3efd89fc1
# Category: 
# Notes: 
# Changed content:
