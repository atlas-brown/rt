...
_get_root() {
  ...
  while true; do
    ...
    _debug h "$h"
################################################################################
# Commit message: Fix: cut for domain uuid with searchDOmain response
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/0b8ae6821303742ebd9ed4423f9c7b64836c9513
# Category: 
# Notes: 
# Changed content:
