...
################################################################################
# Commit message: Add support for RISC-V 64-bit installs  Signed-off-by: MichaIng <micha@dietpi.com>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/b74c6d5120d9630ff835bff70c531e5b16bf9e8d
# Category: 
# Notes: 
# Changed content:
