...
################################################################################
# Commit message: update verifyFreeDiskSpace()...  addresses #322. Will now check free space on the first file system output by 'df- lkP`, as opposed to `/` to make pi-hole more compatible with other distros.
# Commit URL: https://github.com/pi-hole/pi-hole/commit/40f541bc31a23e49853f9536b809f4ab403d0baa
# Category: 
# Notes: 
# Changed content:
