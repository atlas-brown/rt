...
################################################################################
# Commit message: fix bug when the od command is missing
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/9bdb799b412bf86cddbe62d630e94a023fcc532d
# Category: 
# Notes: 
# Changed content:
# + #_ascii_hex str
