...
################################################################################
# Commit message: Debian buildpack image for docker (Need `curl` for testing, using scm version to add `curl` and `git`.)  Signed-off-by: Dan Schaper <dan.schaper@pi-hole.net>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/7a269e757ebbac6c5c2762b012767b30d3b6bdc6
# Category: 
# Notes: 
# Changed content:
