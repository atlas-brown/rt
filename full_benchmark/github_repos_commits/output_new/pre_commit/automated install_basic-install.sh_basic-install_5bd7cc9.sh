...
################################################################################
# Commit message: Replace `which` with `command -v` (#4499)  Signed-off-by: WaLLy3K WaLLy3K@users.noreply.github.com
# Commit URL: https://github.com/pi-hole/pi-hole/commit/5bd7cc9c9d9be16bc6cd499635a19a042088c97e
# Category: 
# Notes: 
# Changed content:
