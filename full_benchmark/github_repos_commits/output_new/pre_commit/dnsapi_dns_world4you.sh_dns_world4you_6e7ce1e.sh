...
################################################################################
# Commit message: dns_world4you: fix for freeBSD sed  Signed-off-by: Lorenz Stechauner <lorenz.stechauner@necronda.net>
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/6e7ce1eec132cd0b5e7e975ecdd03fea68c87cbe
# Category: 
# Notes: 
# Changed content:
