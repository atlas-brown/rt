...
################################################################################
# Commit message: Add --no-check-certificate option to wget, or else the initial deployment won't work because there isn't a valid certificate installed on the router yet.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d50281453d6bc704c0a647b523073f06b002ca34
# Category: 
# Notes: 
# Changed content:
