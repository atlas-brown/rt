...
if [[ $FOUND_RBENV -eq 1 ]]; then
  ...
  function rbenv_prompt_info() {
    echo -n "${ZSH_THEME_RUBY_PROMPT_PREFIX}"
################################################################################
# Commit message: fix: quote % characters in ruby prompt info functions
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/9a3d853481645ae0f961e9cc8421fc5d84e2c3c3
# Category: 
# Notes: 
# Changed content:
