...
################################################################################
# Commit message: basic-install.sh: Use `grep -E` instead of `egrep`  Signed-off-by: a1346054 <36859588+a1346054@users.noreply.github.com>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/9c51050283cc357543cc26df82a6596f5dc3dfdf
# Category: 
# Notes: 
# Changed content:
