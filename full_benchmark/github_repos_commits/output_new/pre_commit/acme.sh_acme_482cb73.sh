...
_readKeyLengthFromCSR() {
  ...
  if _contains "$_outcsr" "Public Key Algorithm: id-ecPublicKey"; then
    _debug "ECC CSR"
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/758
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/482cb737025d691c730594abf8084c0bd1936bc6
# Category: 
# Notes: 
# Changed content:
