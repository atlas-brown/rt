...
################################################################################
# Commit message: Use more widely supported options for the "tr" command line utility by removing the use of the character class representation option. Fixes #2536
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ba7db3edda2c3d4e8265d2c5302b973d6541afd8
# Category: 
# Notes: 
# Changed content:
