...
################################################################################
# Commit message: changes due to inkompabilities of some distros
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d4cf03c9fd0c5dbfaf2292c0f5552382ee4640a0
# Category: 
# Notes: 
# Changed content:
