...
_add_record() {
  ...
  _debug "${response}"
################################################################################
# Commit message: fix: remove sed before grep, but lead to less robusty
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/83a4db3b31f7fb91c4a6c9a3fed447c92d486092
# Category: 
# Notes: 
# Changed content:
