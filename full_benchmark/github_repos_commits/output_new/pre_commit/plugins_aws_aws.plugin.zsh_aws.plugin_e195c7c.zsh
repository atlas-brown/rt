...
################################################################################
# Commit message: fix(aws): pass default region to fetch regions (#12175)  Co-authored-by: Gauthier Delacroix <no@email.com>
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/e195c7cb438224e8bcea20bdbc2e4b8a6bb3949b
# Category: 
# Notes: 
# Changed content:
