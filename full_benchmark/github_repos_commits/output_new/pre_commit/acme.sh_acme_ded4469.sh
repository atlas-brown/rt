...
_h2b() {
  ...
  if [ -z "$_URGLY_PRINTF" ]; then
    if _exists xargs; then
      _debug2 "xargs"
################################################################################
# Commit message: fix for openbsd, sed doesn't support `I` option.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ded4469efe8a61e94d4878c80420cac414c4e6d2
# Category: 
# Notes: 
# Changed content:
