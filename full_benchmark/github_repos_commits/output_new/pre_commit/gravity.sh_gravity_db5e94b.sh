...
gravity_DownloadBlocklistFromUrl() {
  ...
  case $BLOCKINGMODE in
    ...
    "NODATA")
################################################################################
# Commit message: use +short and omit obsolet awk  Co-authored-by: DL6ER <DL6ER@users.noreply.github.com>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/db5e94b14a4e5a0208cd3515cfc4e25356335120
# Category: 
# Notes: 
# Changed content:
