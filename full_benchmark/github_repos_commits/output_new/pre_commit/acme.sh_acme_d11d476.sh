...
################################################################################
# Commit message: "Don't use [] around ranges in tr, it replaces literal square brackets."
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d11d476126a6958211d9813ebf34c1e33f25055a
# Category: 
# Notes: 
# Changed content:
