...
################################################################################
# Commit message: Improved error handling  Improved error handling when result contains data-structure which might contain another status-flag that is related to the status of the related object and not the api call  Revert "Improved error handling"  This reverts commit fa6df1cfab134d38baad19fc1caa0842f00416d5.  Revert "Revert "Improved error handling""  This reverts commit 5a4b78392f063863ee9f56686f5c429e9376af1b.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ba3e088b238382c76922fcf4a312819292bc75cb
# Category: 
# Notes: 
# Changed content:
