...
################################################################################
# Commit message: fix: Synology DSM API path regex  Fix the regex for looking up the API path value from the Synology API query.
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/87a7bde61813391e6c8379ae93c921bd68889c53
# Category: 
# Notes: 
# Changed content:
