...
################################################################################
# Commit message: fix uninstall, compatible with previous versions
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/85fb3776eb614e3171864689bfedb1a4d2c59008
# Category: 
# Notes: 
# Changed content:
# - if crontab -l | grep 'le renewAll' ; then
