...
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/1959
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/a43545c6ea9f79df2acfa1bc10db8f44e803b197
# Category: 
# Notes: 
# Changed content:
