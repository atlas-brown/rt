...
################################################################################
# Commit message: changed shasums file url because in v0.8.6 .txt.asc file is not available.
# Commit URL: https://github.com/nvm-sh/nvm/commit/a6be969403f7d590f9c439d8450deac3199b48d6
# Category: 
# Notes: 
# Changed content:
