...
################################################################################
# Commit message: remove -o option from grep and use _egrep_o instead
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ced7110a78ba8faa6163bbe1f8a786f00ad5c6a9
# Category: 
# Notes: 
# Changed content:
