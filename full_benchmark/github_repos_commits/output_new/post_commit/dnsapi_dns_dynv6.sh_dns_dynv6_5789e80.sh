...
################################################################################
# Commit message: Fixed a bug where the zone_id was corrupted for domains containing the string 'id' dns_dynv6.sh  This will now search for `"id:"` instead of `id` and therefore will only find the id field and not any other field containing the sub-string 'id'
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/5789e80d741462f36fc2b1949a965550c051444d
# Category: 
# Notes: 
# Changed content:
