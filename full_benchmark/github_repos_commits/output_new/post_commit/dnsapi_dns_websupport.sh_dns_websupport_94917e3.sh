...
_ws_rest() {
  ...
  timestamp=$(_time)
################################################################################
# Commit message: Testing double 2>/dev/null into _utc_date with sed
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/94917e315e50e001d55c539d6d2e9f79669679f6
# Category: 
# Notes: 
# Changed content:
