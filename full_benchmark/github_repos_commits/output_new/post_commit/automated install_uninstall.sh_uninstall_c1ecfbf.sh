...
if [ -x "$(command -v apt-get)" ]; then
	...
	package_check() {
################################################################################
# Commit message: linting: Double quote to prevent globbing and word splitting  Signed-off-by: bcambl <blayne@blaynecampbell.com>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/c1ecfbfe63961850f5d8f311fe9be2db08321de4
# Category: 
# Notes: 
# Changed content:
