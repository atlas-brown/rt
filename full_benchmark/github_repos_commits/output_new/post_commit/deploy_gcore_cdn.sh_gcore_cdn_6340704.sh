...
################################################################################
# Commit message: fixed line breaks for support api gcore_cdn (#2237)
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/63407041738634e16b761542bc1de163cfa8b7e5
# Category: 
# Notes: 
# Changed content:
# - _fullchain=$(tr '\n\r' '@#' <"$_cfullchain" | sed 's/@/\\n/g;s/#/\\r/g')
