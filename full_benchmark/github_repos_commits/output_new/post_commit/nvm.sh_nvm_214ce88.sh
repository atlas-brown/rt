...
nvm() {
  ...
  case $1 in
    ...
    "copy-packages" )
      ...
      local INSTALLS
################################################################################
# Commit message: `npm ls` has a bug in some versions when "--parseable --depth=0" is used together.
# Commit URL: https://github.com/nvm-sh/nvm/commit/214ce8853bc19dff38a7bb50a3e8b09986903f8b
# Category: 
# Notes: 
# Changed content:
