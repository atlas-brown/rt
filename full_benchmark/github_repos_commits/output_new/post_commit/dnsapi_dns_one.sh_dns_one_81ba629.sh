...
################################################################################
# Commit message: allow set-cookie as well as Set-Cookie
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/81ba629b5684e75e450345ae6024987ce8d80a90
# Category: 
# Notes: 
# Changed content:
