...
################################################################################
# Commit message: Change grep to be case-insensitive when looking for Set-Cookie header since INWX change casing to lowercase
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/9143cd1485a4a0220897124fec78eb2ec45f81ec
# Category: 
# Notes: 
# Changed content:
