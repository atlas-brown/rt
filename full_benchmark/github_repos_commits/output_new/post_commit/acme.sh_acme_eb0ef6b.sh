...
_readKeyLengthFromCSR() {
  ...
  if _contains "$_outcsr" "Public Key Algorithm: id-ecPublicKey"; then
    ...
    _debug "RSA CSR"
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/614#issuecomment-311160843
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/eb0ef6bd3dd56af440628b9b0f0edeb3753cf863
# Category: 
# Notes: 
# Changed content:
