...
################################################################################
# Commit message: fix(pip): fix `pipupall` error with `freeze` format (#11280)
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/0066280c3e971e1e45a9037f6d0b993dabcc3576
# Category: 
# Notes: 
# Changed content:
