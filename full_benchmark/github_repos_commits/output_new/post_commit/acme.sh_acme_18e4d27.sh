...
_startswith() {
  ...
  _sub="$2"
################################################################################
# Commit message: fix https://github.com/acmesh-official/acme.sh/issues/3806
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/18e4d270d991b772ecd24d4751304372810e7eb3
# Category: 
# Notes: 
# Changed content:
