...
function svn_dirty_choose() {
  if in_svn; then
################################################################################
# Commit message: svn plugin: urldecode repo info  The repo location reported by `svn` is a URL. If you don't decode it before using it a prompt, the `%` sequences will be misinterpreted by prompt expansion and give screwy results. Fixes #2233
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/36fea45bfc564c667007421a643df38c02235c8b
# Category: 
# Notes: 
# Changed content:
