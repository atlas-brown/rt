  ...
  _dokku() {
    ...
    if [[ "$1" = "apps:create" ]]; then
      if [[ -z "$2" ]]; then
        ...
        counter=0
################################################################################
# Commit message: Allow customizing ssh port for the default client  Closes #1942
# Commit URL: https://github.com/dokku/dokku/commit/a765789c4d5ae784fc23b64247af7ebc4fb5384c
# Category: 
# Notes: 
# Changed content:
