...
################################################################################
# Commit message: Use more widely supported options for the "tr" command line utility by removing the use of the character class representation option. [:space:] => "\t\r\n\v\f"
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/573c8f3b13e002cc948adfee840005cc18982098
# Category: 
# Notes: 
# Changed content:
