...
################################################################################
# Commit message: fix(cloudns): fix grep when record start with hyphen symbol
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/7ef2533b98ae0566fc5775c32aa5ebfcfb3b724b
# Category: 
# Notes: 
# Changed content:
