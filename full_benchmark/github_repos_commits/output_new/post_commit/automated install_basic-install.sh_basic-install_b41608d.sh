...
verifyFreeDiskSpace() {
################################################################################
# Commit message: Include fix for regex in verifyFreeDiskSpace()
# Commit URL: https://github.com/pi-hole/pi-hole/commit/b41608d40b9fb5a7330cd42fba947c4337d412c1
# Category: 
# Notes: 
# Changed content:
