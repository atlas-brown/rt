...
################################################################################
# Commit message: Check IPv6 to see if the route is reachable, if not, don't use.  Signed-off-by: Dan Schaper <dan.schaper@pi-hole.net>
# Commit URL: https://github.com/pi-hole/pi-hole/commit/da413834762775e48e20d0f7574a6976a878adc4
# Category: 
# Notes: 
# Changed content:
