...
################################################################################
# Commit message: Fixes gradle autocomplete. Regex did not include subproject tasks before.
# Commit URL: https://github.com/ohmyzsh/ohmyzsh/commit/551d68ad11c65ece0ea2af07a58fe971795bb9e6
# Category: 
# Notes: 
# Changed content:
