...
$_authorizations_map"
    ...
    while true; do
      ...
      if [ "$ACME_VERSION" = "2" ]; then
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/2557 and https://github.com/Neilpang/acme.sh/issues/2544
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/d04c6dd3ac03ff6031cbb0d8a2d86645fe9adb20
# Category: 
# Notes: 
# Changed content:
