...
################################################################################
# Commit message: pick first entry if more than one TXT entry exists
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/b910726c4356383b69601ce3b52a101e0f55353d
# Category: 
# Notes: 
# Changed content:
