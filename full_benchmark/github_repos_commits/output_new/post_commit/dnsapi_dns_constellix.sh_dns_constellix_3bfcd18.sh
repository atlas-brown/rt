...
################################################################################
# Commit message: Workaround for Solaris, as it does not support non-greedy regex
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/3bfcd18a03e532d150b0076643d457aa7d244368
# Category: 
# Notes: 
# Changed content:
