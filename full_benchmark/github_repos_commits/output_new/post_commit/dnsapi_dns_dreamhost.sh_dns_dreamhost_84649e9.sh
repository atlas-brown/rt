...
submit() {
  ...
  if [ -z "$2" ]; then
################################################################################
# Commit message: Addressing PR feedback  Replace printf with echo Move dreamhost to bottom of DNS API list
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/84649e9d20603e402462b09fd1481371cd1b5ebc
# Category: 
# Notes: 
# Changed content:
