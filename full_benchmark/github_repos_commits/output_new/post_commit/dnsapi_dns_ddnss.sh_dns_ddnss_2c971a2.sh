...
_ddnss_rest() {
  ...
  if [ "$method" = "GET" ]; then
################################################################################
# Commit message: Filter out blank lines  Response from the provider has changed so that there are blank lines at the end, which leads to the result can not be parsed correctly
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/2c971a25985049c928597da57e636b5487d19abf
# Category: 
# Notes: 
# Changed content:
