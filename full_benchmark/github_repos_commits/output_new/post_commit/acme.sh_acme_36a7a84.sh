...
$_authorizations_map"
  ...
  if [ "$ACME_VERSION" = "2" ]; then
    ...
    _rcert="$response"
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/1411
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/36a7a84080c25eec363e5de9bc35f084a6ea6133
# Category: 
# Notes: 
# Changed content:
