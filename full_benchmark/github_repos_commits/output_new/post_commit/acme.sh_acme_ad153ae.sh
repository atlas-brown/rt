...
_setopt() {
  ...
  if grep -n "^$__opt$__sep" "$__conf" >/dev/null; then
    ...
    text="$(cat "$__conf")"
################################################################################
# Commit message: fix https://github.com/Neilpang/acme.sh/issues/622
# Commit URL: https://github.com/acmesh-official/acme.sh/commit/ad153ae041f40c4c4d730f35d9e58700ccd25906
# Category: 
# Notes: 
# Changed content:
